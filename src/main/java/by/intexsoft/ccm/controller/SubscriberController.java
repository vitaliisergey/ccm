...
public class SubscriberController {
    ...
    private ResponseItem activate(@PathVariable("id") long subscriberId, @RequestBody ActivateRequestItem body) {
        ...
        try {
            return new ResponseItem(subscriberService.activate(subscriberId, body.packId, body.activateDate,
                    body.deactivateDate));
    ...
    private ResponseItem deactivate(@PathVariable("id") long subscriberId, @RequestBody DeactivateRequestItem body) {
        ...
        try {
            return new ResponseItem(subscriberService.deactivate(subscriberId, body.packId, body.traceNumber,
                    body.deactivateDate));
        } catch (ActionException e) {
